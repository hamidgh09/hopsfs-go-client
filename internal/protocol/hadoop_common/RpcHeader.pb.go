...
type RpcRequestHeaderProto struct {
	...
	RouterFederatedState []byte `protobuf:"bytes,9,opt,name=routerFederatedState" json:"routerFederatedState,omitempty"`
	Epoch                *int64 `protobuf:"varint,10,opt,name=epoch,def=0" json:"epoch,omitempty"` // HopsFS: rpc epoch for retry cache
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
func (x *RpcRequestHeaderProto) GetRouterFederatedState() []byte {
	if x != nil {
		return x.RouterFederatedState
	}
	return nil
}
...
type RpcResponseHeaderProto struct {
	...
	RouterFederatedState []byte `protobuf:"bytes,10,opt,name=routerFederatedState" json:"routerFederatedState,omitempty"`
	Epoch                *int64 `protobuf:"varint,11,opt,name=epoch,def=0" json:"epoch,omitempty"` // HopsFS: rpc epoch for retry cache
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
func (x *RpcResponseHeaderProto) GetRouterFederatedState() []byte {
	if x != nil {
		return x.RouterFederatedState
	}
	return nil
...
const file_RpcHeader_proto_rawDesc = "" +
	...
	"\tsignature\x18\x02 \x01(\fR\tsignature\"\xc3\x04\n" +
	...
	"\rcallerContext\x18\a \x01(\v2$.hadoop.common.RPCCallerContextProtoR\rcallerContext\x12\x18\n" +
	"\astateId\x18\b \x01(\x03R\astateId\x122\n" +
	"\x14routerFederatedState\x18\t \x01(\fR\x14routerFederatedState\x12\x17\n" +
	"\x05epoch\x18\n" +
	" \x01(\x03:\x010R\x05epoch\"]\n" +
	"\x0eOperationProto\x12\x14\n" +
	"\x10RPC_FINAL_PACKET\x10\x00\x12\x1b\n" +
	"\x17RPC_CONTINUATION_PACKET\x10\x01\x12\x18\n" +
	"\x14RPC_CLOSE_CONNECTION\x10\x02\"\x97\a\n" +
	...
	"retryCount\x12\x18\n" +
	"\astateId\x18\t \x01(\x03R\astateId\x122\n" +
	"\x14routerFederatedState\x18\n" +
	" \x01(\fR\x14routerFederatedState\x12\x17\n" +
	"\x05epoch\x18\v \x01(\x03:\x010R\x05epoch\"3\n" +
